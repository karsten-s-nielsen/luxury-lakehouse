...
page_md = build_page(
    PageConfig(
        ...
        metrics=[
            ...
            Metric(
                "Avg Speed (m/s)", "pc_avg_speed", "Average player speed in m/s. Typical match average: 1.5-2.5 m/s."
            ),
            Metric(
                "Max Speed (m/s)",
                "pc_max_speed",
            ...
            Metric(
                "Avg Dist to Ball (m)", "pc_avg_dist_to_ball", "Average distance from players to the ball in meters."
            ),
        ],
    )
)
