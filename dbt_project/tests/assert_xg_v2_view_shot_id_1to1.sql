-- fct_xg_predictions_v2 (view over fct_shot_xg) grain guard (Task 2.4 / §C2).
-- The v2 view reconstructs shot_id via the bridge
...
-- shot). Returns any shot_id emitted more than once by the view (empty = pass).
