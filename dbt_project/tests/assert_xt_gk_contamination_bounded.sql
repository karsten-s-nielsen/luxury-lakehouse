...
-- (2026-07-01 handoff; re-keyed onto xt_gk_v2 at spec §7.4). The mart NULLs the xt_gk_v2 value
-- family for any match where a (match, team) carries more distinct xt_gk_v2-scored players than
-- var('xt_gk_max_scored_players_per_team') — the whole-squad contamination class that is
-- only visible cross-batch at the mart. AFTER that exclusion, NO SERVED (non-NULL xt_gk_v2)
