...
def test_distribution_profile_sql_action_grain_two_axes():
    ...
    # action-grain profile (NOT the degenerate preset columns), floored at n>=20
    ...
    assert "a.xt_gk > 0" in sql and "a.xt_gk IS NOT NULL" in sql and "HAVING COUNT(*) >= 20" in sql
