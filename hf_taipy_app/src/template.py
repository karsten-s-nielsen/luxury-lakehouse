...
GLOSSARY: dict[str, str] = {
    ...
    "xG (v3 Set Encoder)": (
        "Expected goal probability from the v3 Set Encoder model (canonical-SPADL "
        "xg_model_v3) with MC dropout 95% CI. Range 0-1. xg_ci_upper - xg_ci_lower = "
        "model uncertainty. Reference: Gal & Ghahramani 2016 (Dropout as Bayesian Approximation)."
    ),
    "Brier Score": (
...
PAGE_TERMS: dict[str, list[str]] = {
    "Shot-Map": ["xG (Expected Goals)", "xG (v3 Set Encoder)", "Brier Score"],
...
_FILTER_WIDGETS: list[SidebarWidget] = [
    ...
    SidebarWidget(
        ...
        lov="xg_model_lov",
        help="StatsBomb: provider xG. v3 Set Encoder: lakehouse canonical-SPADL Deep Sets model (xg_model_v3) with MC dropout 95% CI (Gal & Ghahramani 2016). Range 0-1, higher = better chance.",
    ),
    SidebarWidget(
        "dropdown",
        "selected_sub_view",
