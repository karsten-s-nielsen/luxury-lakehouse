...
# dependencies = [
#     "luxury-lakehouse[spadl] @ https://huggingface.co/luxury-lakehouse/build-artifacts/resolve/main/luxury_lakehouse-0.5.40-py3-none-any.whl",
#     "databricks-sdk>=0.20",
#     "gensim>=4.3",
...
_REQUIRED_SK_MIN: tuple[int, int, int] = (4, 27, 0)
