...
terraform import 'module.synced_tables.databricks_database_synced_database_table.fct_defensive_values' \
  'soccer_analytics.dev_gold.fct_defensive_values_synced'

terraform import 'module.synced_tables.databricks_database_synced_database_table.fct_defcon_actions' \
  'soccer_analytics.dev_gold.fct_defcon_actions_synced'

terraform import 'module.synced_tables.databricks_database_synced_database_table.fct_defcon_pressure' \
  'soccer_analytics.dev_gold.fct_defcon_pressure_synced'
...
echo "All 14 synced tables imported. Run 'terraform plan' to verify."
