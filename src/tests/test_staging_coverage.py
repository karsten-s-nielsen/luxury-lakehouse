...
RENAMES: dict[tuple[str, str], dict[str, str]] = {
    ...
    ("gradientsports", "gradientsports_metadata"): {
        ...
        "week": "matchweek",
        # PR-2a: the 20 previously-undocumented metadata cols, now documented in sources.yml
        # and carried through staging. Dot-named bronze cols need an entry here so the coverage
        # test can map bronze name -> staging name.
        "id": "gs_metadata_row_id",
        "videoUrl": "video_url",
        "startPeriod1": "start_period_1",
        "endPeriod1": "end_period_1",
        "startPeriod2": "start_period_2",
        "endPeriod2": "end_period_2",
        "period1": "period_1",
        "period2": "period_2",
        "halfPeriod": "half_period",
        "stadium.pitches": "stadium_pitches",
        "homeTeamKit.name": "home_team_kit_name",
        "homeTeamKit.primaryColor": "home_team_kit_primary_color",
        "homeTeamKit.primaryTextColor": "home_team_kit_primary_text_color",
        "homeTeamKit.secondaryColor": "home_team_kit_secondary_color",
        "homeTeamKit.secondaryTextColor": "home_team_kit_secondary_text_color",
        "awayTeamKit.name": "away_team_kit_name",
        "awayTeamKit.primaryColor": "away_team_kit_primary_color",
        "awayTeamKit.primaryTextColor": "away_team_kit_primary_text_color",
        "awayTeamKit.secondaryColor": "away_team_kit_secondary_color",
        "awayTeamKit.secondaryTextColor": "away_team_kit_secondary_text_color",
    },
