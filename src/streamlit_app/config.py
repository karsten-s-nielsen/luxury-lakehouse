...
class AppSettings(BaseSettings):
    """Streamlit app settings bound to environment variables."""
    ...
    def pg_schema_prefix(self) -> str:
        ...
        In Lakebase PG, the Unity Catalog schema maps directly to a PG
        schema (e.g. 'dev_gold'). The catalog maps to the PG database.
        """
