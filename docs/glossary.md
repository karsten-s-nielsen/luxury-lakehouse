...
| **Synced table** | A Lakebase table that mirrors a Delta table in near-real-time to PostgreSQL. Important operational note: SNAPSHOT synced tables require manual refresh after dbt rebuilds (see scripts/refresh_synced_tables.py) | — |
